...
//			System.out.println("Output file is "+prefs.getGenomeBase()+"/"+assembly+".zip");
			...
			try {	
				...
				d.close();
				throw new ConclaveException("Could't write into your genomes directory.  Please check your file preferences.");
			}
...
//				System.out.println("Found entry "+ze.getName()+" with size "+ze.getSize());
				...
				try {	
					...
					throw new ConclaveException("Couldn't write into the genomes directory.  Please check your file permissions or change your genomes folder.");
				}
