 ...
 */
package uk.ac.babraham.conclave.Network.DownloadableGenomes;
...
public class DownloadableGenomeSet {
	...
	public DownloadableGenomeSet () throws IOException {
		...
		URL genomeIndexURL = new URL(ConclavePreferences.getInstance().getGenomeDownloadLocation()+"genome_index.txt");
...
//			System.out.println("Found organism "+sections[0]+" and assembly "+sections[1]);
	...
	public GenomeAssembly [] findUpdateableGenomes () throws IOException {
		...
		File [] speciesFolders = ConclavePreferences.getInstance().getGenomeBase().listFiles();
