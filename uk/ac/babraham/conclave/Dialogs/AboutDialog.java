...
import uk.ac.babraham.conclave.Displays.WelcomePanel.ConclaveTitlePanel;
...
public class AboutDialog extends JDialog {
     ...
     */
    public AboutDialog () {
    	super(ConclaveApplication.getInstance());
        setTitle("About SeqMonk...");  
        Container cont = getContentPane();
        cont.setLayout(new BorderLayout());
        
        add(new ConclaveTitlePanel(),BorderLayout.CENTER);
