...
import uk.ac.babraham.conclave.Displays.ManualGenomeBuilder.ManualGenomeBuilderDialog;
...
public class GenomeSelector extends JDialog {
	 ...
	 */
	public GenomeSelector (ConclaveApplication application) {
		...
		File[] genomes;
		try {
			genomes = ConclavePreferences.getInstance().getGenomeBase().listFiles();
			if (genomes == null) {
