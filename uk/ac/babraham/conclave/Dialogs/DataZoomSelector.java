...
import uk.ac.babraham.conclave.Displays.GradientScaleBar.GradientPanel;
import uk.ac.babraham.conclave.Displays.GradientScaleBar.GradientScaleAxis;
import uk.ac.babraham.conclave.Preferences.DisplayPreferences;
import uk.ac.babraham.conclave.Preferences.DisplayPreferencesListener;
...
public class DataZoomSelector extends JDialog implements ActionListener, ChangeListener, DisplayPreferencesListener {
	 ...
	 * @param application
	 */
	public DataZoomSelector(ConclaveApplication application) {
