 ...
 */
package uk.ac.babraham.conclave.Dialogs.ConclavePreview;
...
public class ConclavePreviewPanel extends JPanel implements PropertyChangeListener {

	private JLabel label;
	
	public ConclavePreviewPanel () {
	...
	private void previewFile (File file) {
		...
		try {
			ConclavePreview preview = new ConclavePreview(file);
