...
public class BedGraphDataWriter implements Runnable, Cancellable {
	...
	public void startProcessing () {
		...
		if (!existingFiles.isEmpty()) {
			...
			int answer = JOptionPane.showOptionDialog(ConclaveApplication.getInstance(),sb.toString()+" exists.  Do you want to overwrite the existing file(s)?","Overwrite file(s)?",0,JOptionPane.QUESTION_MESSAGE,null,new String [] {"Overwrite and Save","Cancel"},"Overwrite and Save");
