 ...
 */
package uk.ac.babraham.conclave.Displays.ScatterPlot;
...
import uk.ac.babraham.conclave.Dialogs.OrderedListSelector;
 ...
 */
public class ScatterPlotDialog extends JDialog implements ActionListener, ChangeListener {
	 ...
	 */
	public ScatterPlotDialog (DataCollection collection) {
		super(ConclaveApplication.getInstance(),"ScatterPlot");
		this.collection = collection;
		this.probeList = collection.probeSet().getActiveList();
		
		if (collection.probeSet() != null) {
			setTitle("ScatterPlot ["+collection.probeSet().getActiveList().name()+"]");
		}
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getActionCommand().equals("close")){
			...
			if (scatterPlotPanel instanceof ScatterPlotPanel) {
				...
				list.setDescription("[Scatterplot Manual Selection] "+list.description());
