 ...
 */
package uk.ac.babraham.conclave.Displays.CodonBiasPlot;
...
public class CodonBiasPanel extends JPanel implements Runnable {
	...
	public void run() {
		...
		long [] reads = store.getReadsForProbe(new Probe(ConclaveApplication.getInstance().dataCollection().genome().getExactChromsomeNameMatch(feature.chromosomeName()), feature.location().packedPosition()));
