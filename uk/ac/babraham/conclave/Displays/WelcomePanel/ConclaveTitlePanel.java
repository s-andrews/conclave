 ...
 */
public class ConclaveTitlePanel extends JPanel {
	...
	public ConclaveTitlePanel () {
		...
		JLabel program = new SmoothJLabel("Conclave Integrative Genomics Application",JLabel.CENTER);
		program.setFont(new Font("Dialog",Font.BOLD,18));
		program.setForeground(ColourScheme.FORWARD_FEATURE);
		c.add(program,constraints);

		constraints.gridy++;
		JLabel version = new SmoothJLabel("Version: "+ConclaveApplication.VERSION, JLabel.CENTER);
		...
		JLabel copyright = new JLabel("\u00a9 Simon Andrews,Laura Biggins Babraham Bioinformatics, 2020", JLabel.CENTER);
