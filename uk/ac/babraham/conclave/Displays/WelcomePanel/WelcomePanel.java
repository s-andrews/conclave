...
public class WelcomePanel extends JPanel {
	...
	private ConclaveInformationPanel infoPanel;
	
	public WelcomePanel (ConclaveApplication application) {
		...
		add(new ConclaveTitlePanel(),gbc);
		gbc.gridy++;
		infoPanel = new ConclaveInformationPanel(application);
		add(infoPanel,gbc);
