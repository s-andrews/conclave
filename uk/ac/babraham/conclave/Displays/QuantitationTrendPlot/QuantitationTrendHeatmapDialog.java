...
import uk.ac.babraham.conclave.Displays.QuantitationTrendPlot.HeatmapPanel.QuantitationHeatmapPanelGroup;
...
public class QuantitationTrendHeatmapDialog extends JDialog implements ChangeListener, ActionListener {
	...
	public QuantitationTrendHeatmapDialog (QuantitationTrendData data) {
		super(ConclaveApplication.getInstance(),"Quantitation Trend Heatmap");
