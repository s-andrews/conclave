 ...
 */
package uk.ac.babraham.conclave.Displays.Report;
...
import uk.ac.babraham.conclave.Reports.Report;
...
import uk.ac.babraham.conclave.Utilities.FileFilters.TxtFileFilter;
import uk.ac.babraham.conclave.Vistory.Vistory;
import uk.ac.babraham.conclave.Vistory.VistoryTable;
...
public class ReportTableDialog extends JDialog implements MouseListener, ActionListener {
	 ...
	 */
	public ReportTableDialog (ConclaveApplication application, Report report, TableModel originalModel) {
