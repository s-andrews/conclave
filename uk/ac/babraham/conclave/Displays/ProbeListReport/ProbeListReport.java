...
public class ProbeListReport {
	...
	public ProbeListReport (ProbeList list) {
		...
		try {
			...
			ReplicateSet [] replicates = ConclaveApplication.getInstance().dataCollection().getAllReplicateSets();
			...
			xhtml.writeStartElement("td");
			xhtml.writeCharacters(ConclaveApplication.getInstance().projectName());
			xhtml.writeEndElement(); //th
			...
			xhtml.writeStartElement("td");
			xhtml.writeCharacters(ConclaveApplication.getInstance().dataCollection().genome().toString());
			xhtml.writeEndElement(); //th
			...
			xhtml.writeStartElement("td");
			xhtml.writeCharacters("SeqMonk v"+ConclaveApplication.VERSION);
			xhtml.writeEndElement(); //th
