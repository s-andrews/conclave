 ...
 */
package uk.ac.babraham.conclave.Displays.ChromosomeViewer;
...
import uk.ac.babraham.conclave.Utilities.PositionFormat;
...
public class ChromosomeViewer extends JPanel implements DataChangeListener, DisplayPreferencesListener, MouseWheelListener {
	 ...
	 * @param chromosome
	 */
	public ChromosomeViewer (ConclaveApplication application, Chromosome chromosome) {
