 ...
 */
package uk.ac.babraham.conclave.Displays.StarWars;
...
import uk.ac.babraham.conclave.Analysis.Statistics.StarWars;
import uk.ac.babraham.conclave.Displays.BeanPlot.BeanPlotScaleBar;

public class MultiStarWarsPanel extends JPanel {
		
	public MultiStarWarsPanel (StarWars [] whiskers, String [] names, String panelName, float min, float max) {
		...
		for (int i=0;i<whiskers.length;i++) {
			...
			gbc.weighty=0.999;
			gbc.gridy=2;
			add(new StarWarsPanel(whiskers[i], min, max),gbc);
		}
	}
