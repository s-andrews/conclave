 ...
 */
package uk.ac.babraham.conclave.Displays.HistogramPlot;
...
public class ProbeValueHistogramPlot extends JDialog implements ActionListener, Runnable {
	 ...
	 */
	public ProbeValueHistogramPlot (DataStore d, ProbeList p) throws ConclaveException {
		super(ConclaveApplication.getInstance(),"Probe Values Plot ["+d.name()+"]");
		setSize(800,600);
