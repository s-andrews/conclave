...
public class CumulativeDistributionPanel extends JPanel {
	...
	public CumulativeDistributionPanel (DataStore store, ProbeList [] lists) throws ConclaveException {

		if (!store.isQuantitated()) {
			throw new ConclaveException("Data store wasn't quantitated");
		}
	...
	public CumulativeDistributionPanel (DataStore [] stores, ProbeList list) throws ConclaveException {
