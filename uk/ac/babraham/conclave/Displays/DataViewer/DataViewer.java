...
import uk.ac.babraham.conclave.DataWriters.BedDataWriter;
import uk.ac.babraham.conclave.Dialogs.AnnotationSetPropertiesDialog;
import uk.ac.babraham.conclave.Dialogs.DataStorePropertiesDialog;
import uk.ac.babraham.conclave.Dialogs.ProbeListCommentEditDialog;
import uk.ac.babraham.conclave.Dialogs.ProbeListViewer;
import uk.ac.babraham.conclave.Dialogs.SimilarProbeListsDialog;
...
public class DataViewer extends JPanel  implements MouseListener, TreeSelectionListener {
	 ...
	 * @param application
	 */
	public DataViewer (ConclaveApplication application) {
