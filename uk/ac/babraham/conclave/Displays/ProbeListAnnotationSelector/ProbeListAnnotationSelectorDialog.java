package uk.ac.babraham.conclave.Displays.ProbeListAnnotationSelector;
...
import uk.ac.babraham.conclave.Displays.DataViewer.DataTreeRenderer;
import uk.ac.babraham.conclave.Displays.DataViewer.ProbeSetTreeModel;
...
public class ProbeListAnnotationSelectorDialog extends JDialog implements ActionListener,TreeSelectionListener {
	...
	public ProbeListAnnotationSelectorDialog (ProbeListAnnotation [] alreadySelected) {
		...
		super(ConclaveApplication.getInstance(),"Select Annotations",true);
		...
		tree = new JTree(new ProbeSetTreeModel(ConclaveApplication.getInstance().dataCollection()));
