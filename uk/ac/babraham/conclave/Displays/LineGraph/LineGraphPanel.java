 ...
 */
package uk.ac.babraham.conclave.Displays.LineGraph;
...
public class LineGraphPanel extends JPanel implements Runnable, MouseListener {
	...
	public LineGraphPanel (DataStore [] stores, ProbeList probes) throws ConclaveException {
		...
		if (this.stores.length < 2) {
			throw new ConclaveException("At least 2 quantitated data stores are required to draw a line graph");
		}
