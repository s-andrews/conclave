...
import uk.ac.babraham.conclave.Dialogs.OrderedReplicateSetSelector;
import uk.ac.babraham.conclave.Displays.TsneDataStorePlot.TsneDataStoreResult;
...
public class PCAScatterPlotDialog extends JDialog implements ActionListener, ChangeListener {
	...
	public PCAScatterPlotDialog (PCASource data) {
		super(ConclaveApplication.getInstance(),"PCA Plot");
		this.data = data;
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getActionCommand().equals("close")){
			...
			// in the plot
			OrderedReplicateSetSelector selector = new OrderedReplicateSetSelector(this,ConclaveApplication.getInstance().dataCollection().getAllReplicateSets(),highlightedSets);
