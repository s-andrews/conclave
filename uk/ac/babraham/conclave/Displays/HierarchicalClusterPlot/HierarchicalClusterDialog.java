 ...
 */
package uk.ac.babraham.conclave.Displays.HierarchicalClusterPlot;
...
import uk.ac.babraham.conclave.DataTypes.Cluster.ClusterDataSource;
import uk.ac.babraham.conclave.DataTypes.Cluster.ClusterPair;
import uk.ac.babraham.conclave.DataTypes.Cluster.HierarchicalClusterSet;
...
import uk.ac.babraham.conclave.Displays.GradientScaleBar.GradientScaleBar;
import uk.ac.babraham.conclave.Gradients.ColourGradient;
import uk.ac.babraham.conclave.Gradients.GradientFactory;
import uk.ac.babraham.conclave.Gradients.InvertedGradient;
...
public class HierarchicalClusterDialog extends JDialog implements ProgressListener, ChangeListener, ActionListener {
	...
	public HierarchicalClusterDialog (ProbeList probes, DataStore [] stores, boolean normalise) {
		super(ConclaveApplication.getInstance(),"Hierarchical Clusters for "+probes.name());
		this.probes = probes;
		...
		if (probes.getAllProbes().length > 5000) {
			...
			JOptionPane.showMessageDialog(ConclaveApplication.getInstance(),
