...
import uk.ac.babraham.conclave.Vistory.VistoryBlock;
import uk.ac.babraham.conclave.Vistory.VistoryListener;
...
public class VistoryDialog extends JFrame implements VistoryListener {
	...
	private VistoryDialog () {
		super("Vistory");
		setIconImage(ConclaveApplication.getInstance().getIconImage());
