...
public class DomainogramPreferencesDialog extends JDialog implements ActionListener {
	...
	public DomainogramPreferencesDialog (DataStore [] data, ProbeList list) {
		...
		super(ConclaveApplication.getInstance(),"Domainogram Prefs");
		...
		if (keepers.size() == 0) {
			JOptionPane.showMessageDialog(ConclaveApplication.getInstance(), "No quatitated visible data stores to plot", "Can't plot domainogram", JOptionPane.INFORMATION_MESSAGE);
			return;
		}
