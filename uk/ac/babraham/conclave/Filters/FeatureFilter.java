...
import uk.ac.babraham.conclave.Displays.FeaturePositionSelector.FeaturePositionSelectorPanel;
...
public class FeatureFilter extends ProbeFilter {
	...
	public FeatureFilter(DataCollection collection) throws ConclaveException {
		super(collection);
