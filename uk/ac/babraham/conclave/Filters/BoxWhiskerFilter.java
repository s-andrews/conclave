...
import uk.ac.babraham.conclave.Analysis.Statistics.BoxWhisker;
...
public class BoxWhiskerFilter extends ProbeFilter {
	 ...
	 * @throws ConclaveException if the collection is not quantiated
	 */
	public BoxWhiskerFilter (DataCollection collection) throws ConclaveException {
	 ...
	 * @throws ConclaveException If the collection is not quantitated.
	 */
	public BoxWhiskerFilter (DataCollection collection, DataStore [] stores, int outlierType, int filterType, double stringency, int storeCutoff) throws ConclaveException {
		super(collection);
