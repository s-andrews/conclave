...
public class ProbeNameFilter extends ProbeFilter {
	 ...
	 */
	public ProbeNameFilter (DataCollection collection)  throws ConclaveException {
	 ...
	 */
	public ProbeNameFilter (DataCollection collection,String [] queries, boolean stripSuffixes, boolean stripTranscript) throws ConclaveException {
		super(collection);
