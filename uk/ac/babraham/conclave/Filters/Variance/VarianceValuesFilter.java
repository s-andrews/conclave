...
public class VarianceValuesFilter extends ProbeFilter {
	 ...
	 */
	public VarianceValuesFilter (DataCollection collection) throws ConclaveException {
		super(collection);
	}
...
//						System.err.println("Raw value is "+d+" smoothed value is "+localValue);
	...
	private float getVarianceMeasure (ReplicateSet r, Probe p) throws ConclaveException {
