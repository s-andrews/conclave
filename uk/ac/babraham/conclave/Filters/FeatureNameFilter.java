...
public class FeatureNameFilter extends ProbeFilter {
	 ...
	 */
	public FeatureNameFilter (DataCollection collection)  throws ConclaveException {
	 ...
	 */
	public FeatureNameFilter (DataCollection collection,String annotationType, boolean stripSuffixes) throws ConclaveException {
		super(collection);
