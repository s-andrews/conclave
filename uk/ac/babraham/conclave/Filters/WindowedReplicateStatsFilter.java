 ...
 */
package uk.ac.babraham.conclave.Filters;
...
import uk.ac.babraham.conclave.Analysis.Statistics.AnovaTest;
import uk.ac.babraham.conclave.Analysis.Statistics.BenjHochFDR;
import uk.ac.babraham.conclave.Analysis.Statistics.ProbeGroupTTestValue;
...
import uk.ac.babraham.conclave.Filters.ProbeGroupGenerator.ConsecutiveProbeGenerator;
import uk.ac.babraham.conclave.Filters.ProbeGroupGenerator.FeatureProbeGroupGenerator;
import uk.ac.babraham.conclave.Filters.ProbeGroupGenerator.ProbeGroupGenerator;
import uk.ac.babraham.conclave.Filters.ProbeGroupGenerator.ProbeWindowGenerator;
...
public class WindowedReplicateStatsFilter extends ProbeFilter {
	 ...
	 * @throws ConclaveException if the dataCollection isn't quantiated.
	 */
	public WindowedReplicateStatsFilter (DataCollection collection) throws ConclaveException {
		super(collection);
		// Set some defaults
		cutoff = 0.01;
		windowSize = 1000;
