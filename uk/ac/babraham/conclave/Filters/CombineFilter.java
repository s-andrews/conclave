...
public class CombineFilter extends ProbeFilter {
	 ...
	 * @throws ConclaveException if the dataCollection is not quantitated
	 */
	public CombineFilter (DataCollection collection, ProbeList firstList, ProbeList secondList, int combineType) throws ConclaveException {
		super(collection);
	 ...
	 */
	public CombineFilter (DataCollection collection) throws ConclaveException {
