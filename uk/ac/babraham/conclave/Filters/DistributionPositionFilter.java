...
public class DistributionPositionFilter extends ProbeFilter {
	 ...
	 * @throws ConclaveException if the dataCollection was not quantitated
	 */
	public DistributionPositionFilter (DataCollection collection) throws ConclaveException {
		super(collection);
	}
