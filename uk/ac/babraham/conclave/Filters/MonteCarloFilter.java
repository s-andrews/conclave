...
public class MonteCarloFilter extends ProbeFilter {
	 ...
	 */
	public MonteCarloFilter (DataCollection collection) throws ConclaveException {
		super(collection);
	}
	...
	public float getValue (Probe [] probes) throws ConclaveException {
		...
		default:
			throw new ConclaveException("Unknown test type value "+testType);
		}
