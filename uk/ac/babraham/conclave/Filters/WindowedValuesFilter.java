...
public class WindowedValuesFilter extends ProbeFilter {
	 ...
	 */
	public WindowedValuesFilter (DataCollection collection) throws ConclaveException {
		super(collection);
	}
	...
	protected void generateProbeList() {
		...
		for (int c=0;c<chromosomes.length;c++) {
			...
			if (windowType == DISTANCE_WINDOW) {
				...
				progressExceptionReceived(new ConclaveException("No window type known with number "+windowType));
				return;
			}
