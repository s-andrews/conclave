...
import uk.ac.babraham.conclave.DataTypes.Probes.ProbeStrandType;
...
public class PositionFilter extends ProbeFilter {
	 ...
	 */
	public PositionFilter (DataCollection collection) throws ConclaveException {
	 ...
	 */
	public PositionFilter (DataCollection collection, Chromosome selectedChromosome, int start, int end) throws ConclaveException {
		super(collection);
