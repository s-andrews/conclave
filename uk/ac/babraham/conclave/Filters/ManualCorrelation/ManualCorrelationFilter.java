 ...
 */
package uk.ac.babraham.conclave.Filters.ManualCorrelation;
...
import uk.ac.babraham.conclave.Analysis.Correlation.PearsonCorrelation;
...
public class ManualCorrelationFilter extends ProbeFilter {
	 ...
	 */
	public ManualCorrelationFilter (DataCollection collection) throws ConclaveException {
		super(collection);
