 ...
 */
package uk.ac.babraham.conclave.Pipelines.Options;
...
import uk.ac.babraham.conclave.Pipelines.Pipeline;
...
public class DefinePipelineOptions extends JDialog implements ActionListener, ProgressListener, OptionsListener, ListSelectionListener {
	 ...
	 */
	public DefinePipelineOptions (ConclaveApplication application) {
