...
public class PearsonCorrelation {
	 ...
	 * @throws ConclaveException if the two datasets don't have the same number of points in them.
	 */
	public static float calculateCorrelation (int [] data1, int [] data2) throws ConclaveException {
	 ...
	 * @throws ConclaveException if the two datasets don't have the same number of points in them.
	 */
	public static float calculateCorrelation (double [] data1, double [] data2) throws ConclaveException {
	
		if (data1.length != data2.length) {
			throw new ConclaveException("Data sets must be the same length when calculating correlation");
		}
	 ...
	 * @throws ConclaveException if the two datasets don't have the same number of points in them.
	 */
	public static float calculateCorrelation (float [] data1, float [] data2) throws ConclaveException {
