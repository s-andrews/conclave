...
public class StarWars {
	 ...
	 */
	public StarWars (DataStore data, ProbeList probes) throws ConclaveException {
		this(data,probes,3);
	}
	 ...
	 * @throws ConclaveException the seq monk exception
	 */
	public StarWars (DataStore data, ProbeList probes, double stringency) throws ConclaveException {
		this.data = data;
