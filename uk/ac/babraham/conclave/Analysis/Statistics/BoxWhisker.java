...
public class BoxWhisker {
	 ...
	 */
	public BoxWhisker (DataStore data, ProbeList probes) throws ConclaveException {
		this(data,probes,3);
	}
	 ...
	 * @throws ConclaveException the seq monk exception
	 */
	public BoxWhisker (DataStore data, ProbeList probes, double stringency) throws ConclaveException {
		this.data = data;
	 ...
	 * @throws ConclaveException the seq monk exception
	 */
	public void setStringency (double stringency) throws ConclaveException {
		this.stringency = stringency;
		calculateRanges();
	}
	 ...
	 * @throws ConclaveException the seq monk exception
	 */
	private void calculateRanges() throws ConclaveException {
