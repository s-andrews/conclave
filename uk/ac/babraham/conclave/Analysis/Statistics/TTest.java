 ...
 */
package uk.ac.babraham.conclave.Analysis.Statistics;
...
public class TTest {
	 ...
	 * @return the p-value
	 * @throws ConclaveException if there isn't enough data
	 */
	public static double calculatePValue (double [] values1, double [] values2) throws ConclaveException {

		if (values1 == null  || values2 == null) {
			throw new ConclaveException ("Lists of values for t-test cannot be null");
		}
		if (values1.length < 2 || values2.length < 2) {
			throw new ConclaveException("At least two values are required in each set for a t-test");
		}
	 ...
	 * @throws ConclaveException if not enough data is found.
	 */
	public static double calculatePValue (double [] values, double testBase) throws ConclaveException {

		if (values == null) {
			throw new ConclaveException ("List of values for t-test cannot be null");
		}
		if (values.length < 2) {
			throw new ConclaveException("At least two values are required for a t-test");
		}
		double mean =0;
