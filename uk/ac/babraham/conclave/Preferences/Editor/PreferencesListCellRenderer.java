...
package uk.ac.babraham.conclave.Preferences.Editor;
...
public class PreferencesListCellRenderer implements ListCellRenderer {
	...
	public PreferencesListCellRenderer (NamedValueObject [] objects) {
		...
		for (int i=0;i<objects.length;i++) {
			...
			URL url = ClassLoader.getSystemResource("uk/ac/babraham/Conclave/Resources/DisplayPrefsIcons/"+objects[i].toString()+".png");
