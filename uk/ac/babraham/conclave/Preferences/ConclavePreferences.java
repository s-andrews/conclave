 ...
 */
public class ConclavePreferences {

	/** The single instantiated instance of preferences */
	private static ConclavePreferences p = new ConclavePreferences();
	 ...
	 */
	private ConclavePreferences () {
				
		preferencesFile= new File(System.getProperty("user.home")+"/conclave_prefs.txt");
...
//			System.out.println("Loading preferences from file...");
	 ...
	 */
	public static ConclavePreferences getInstance () {		
		return p;
	}
