 ...
 */
package uk.ac.babraham.conclave.Quantitation.Options;
...
import uk.ac.babraham.conclave.Quantitation.ManualCorrectionQuantitation;
import uk.ac.babraham.conclave.Quantitation.MatchDistributionsQuantitation;
import uk.ac.babraham.conclave.Quantitation.PerProbeNormalisationQuantitation;
import uk.ac.babraham.conclave.Quantitation.PercentileNormalisationQuantitation;
import uk.ac.babraham.conclave.Quantitation.ProbeLengthQuantitation;
import uk.ac.babraham.conclave.Quantitation.Quantitation;
import uk.ac.babraham.conclave.Quantitation.RankQuantitation;
import uk.ac.babraham.conclave.Quantitation.RelativeQuantitation;
import uk.ac.babraham.conclave.Quantitation.SizeFactorNormalisationQuantitation;
import uk.ac.babraham.conclave.Quantitation.SmoothingQuantitation;
import uk.ac.babraham.conclave.Quantitation.SmoothingSubtractionQuantitation;
import uk.ac.babraham.conclave.Quantitation.SubsetNormalisationQuantitation;
import uk.ac.babraham.conclave.Quantitation.ZScoreQuantitation;
...
public class DefineQuantitationOptions extends JDialog implements ActionListener, ProgressListener, OptionsListener, ListSelectionListener {
	 ...
	 */
	public DefineQuantitationOptions (ConclaveApplication application) {
