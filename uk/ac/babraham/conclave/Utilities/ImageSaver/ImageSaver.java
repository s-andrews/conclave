...
import uk.ac.babraham.conclave.Utilities.FileFilters.PNGFileFilter;
import uk.ac.babraham.conclave.Utilities.FileFilters.SVGFileFilter;
...
public class ImageSaver {
	...
	public static void saveImage (Component c) {
		...
		int answerIndex = JOptionPane.showOptionDialog(ConclaveApplication.getInstance(), "Save to Clipboard, File or Vistory?", "Destination?", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, new String[] {"Clipboard","Vistory","File"}, "Vistory");
