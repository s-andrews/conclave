...
public class FastaFileFilter extends FileFilter {
	...
	public boolean accept(File f) {
		if (f.isDirectory() || f.getName().toLowerCase().endsWith(".fasta.gz") || f.getName().toLowerCase().endsWith(".fa") || f.getName().toLowerCase().endsWith(".fa.gz") || f.getName().toLowerCase().endsWith(".fasta")) {
			return true;
		}
		else {
			return false;
