...
public class ChromosomeNameTranslator {
	 ...
	 * @throws ConclaveException Thrown if this chromosome is not in the genome used to instantiate the class
	 */
	 ...
	 * @throws ConclaveException If we couldn't match the name to any chromosome
	 */
